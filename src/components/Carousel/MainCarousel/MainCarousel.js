...
class Carousel extends Component {
	...
	auto = () => {
		this.setState((prevState) => {
			return {
				...prevState,
				slideIndex:
					prevState.slideIndex >= this.state.cards.length - 1
						? 0
	...
	setSpacer() {
		...
		if (this.state.slideIndex >= Math.round(this.state.cards.length / 2)) {
			dotsWrapperWidth =
				(this.state.cards.length - (this.state.cards.length - this.state.slideIndex - 1)) *
					12 +
				20 *
					(this.state.cards.length -
						(this.state.cards.length - this.state.slideIndex - 1)) -
				20;
			...
			dotsWrapperWidth =
				(this.state.cards.length - this.state.slideIndex) * 12 +
				(20 * (this.state.cards.length - this.state.slideIndex) - 20);
